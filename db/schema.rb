...
ActiveRecord::Schema.define(version: 2020_11_27_010418) do
  ...
  create_table "crowdnesses", force: :cascade do |t|
    ...
    t.index ["spot_id"], name: "index_crowdnesses_on_spot_id"
    t.index ["user_id"], name: "index_crowdnesses_on_user_id"
  end
